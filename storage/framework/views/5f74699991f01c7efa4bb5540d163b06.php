        ...
        <div class="col-12 col-mid-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('pegawai.halaman')); ?>">
                            <div class="row mb-3">
                                <div class="col-md-3">
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Fadhlan\Documents\Joki\Rejan\DPU-Kerja Praktik\resources\views/pegawai/halaman.blade.php ENDPATH**/ ?>