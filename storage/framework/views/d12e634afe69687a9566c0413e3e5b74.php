                    ...
                    <form method="GET" action="<?php echo e(route('pegawai.absen')); ?>">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="search" name="search" class="form-control" placeholder="Nama atau NIP" value="<?php echo e(request('search')); ?>">
                            </div>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\FIXED\DPU-Kerja Praktik\resources\views/pegawai/absensi.blade.php ENDPATH**/ ?>