...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('nip')); ?>" placeholder="" required>
                                            <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('nama')); ?>" placeholder="" required>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('unit_kerja')); ?>" placeholder="" required>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\DPU-Kerja Praktik\resources\views/absensi/absensi.blade.php ENDPATH**/ ?>