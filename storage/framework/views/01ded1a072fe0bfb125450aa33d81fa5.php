...
<section class="section">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id_pelatihan" value="<?php echo e($pelatihan->id_materi); ?>">
                        ...
                        <div class="card-body">
                            <div class="mt-5">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="mt-5">
                                        <a href="<?php echo e(route('absensi', ['id_pelatihan' => $pelatihan->id, 'jumlah_tests' => '', 'jumlah_status_benar' => ''])); ?>" 
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Fadhlan\Documents\Joki\Rejan\DPU-Kerja Praktik\resources\views/pelatihan/show.blade.php ENDPATH**/ ?>