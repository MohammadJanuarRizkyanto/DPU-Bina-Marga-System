        ...
        <div class="row match-height">
            <div class="col-md-12 col-12">
                ...
                <div class="card-header text-center">
                        <h4 class="card-title">Tambah Materi Pelatihan Pegawai</h4>
...
unset($__errorArgs, $__bag); ?>" 
                                                value="<?php echo e(old('jam', date('H:i', strtotime($materi->jam)))); ?>" placeholder="Masukkan Durasi Jam">
                                            <?php $__errorArgs = ['jam'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\FIXED\DPU-Kerja Praktik\resources\views/materi/edit.blade.php ENDPATH**/ ?>