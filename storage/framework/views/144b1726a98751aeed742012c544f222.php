        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="<?php echo e(route('pelatihan.update', ['id' => $pelatihan->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pelatihan->id_materi); ?>" placeholder="Masukkan ID materi" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pelatihan->judul_training); ?>" placeholder="Masukkan Judul Training" required>
                                    </div>
                                    <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pelatihan->tanggal_training); ?>" placeholder="Masukkan Tanggal Pelatihan" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pelatihan->jenis_training); ?>" placeholder="Masukkan Jenis Pelatihan" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($pelatihan->tempat_training); ?>" placeholder="Masukkan Tempat Lokasi Pelatihan" required>
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select id="pelaksanaan_training" name="pelaksanaan_training" class="form-control" required>
                                            <option value="Luring" <?php echo e($pelatihan->pelaksanaan_training == 'Luring' ? 'selected' : ''); ?>>Luring (Offline)</option>
                                            <option value="Daring" <?php echo e($pelatihan->pelaksanaan_training == 'Daring' ? 'selected' : ''); ?>>Daring (Online)</option>
                                            <option value="Hybrid" <?php echo e($pelatihan->pelaksanaan_training == 'Hybrid' ? 'selected' : ''); ?>>Hybrid (Offline & Online)</option>
                                        </select>
                                    </div>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\FIXED\DPU-Kerja Praktik\resources\views/pelatihan/edit.blade.php ENDPATH**/ ?>