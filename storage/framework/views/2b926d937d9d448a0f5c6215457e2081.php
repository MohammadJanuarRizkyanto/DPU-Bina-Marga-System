...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('id_absensi', $next_id_absensi)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('id_training', $id_pelatihan)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('nip_pegawai', $nip_pegawai)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <!-- ID Test -->
                                            ...
                                            <div class="col-md-8 form-group">
                                                <select name="id_test[]" id="id_test" class="form-control <?php $__errorArgs = ['id_test'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple required>
                                                    <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($test->id); ?>"><?php echo e($test->id); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('jumlah_test', $jumlah_test)); ?>" readonly>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\FIXED\DPU-Kerja Praktik\resources\views/absensi/absensi.blade.php ENDPATH**/ ?>