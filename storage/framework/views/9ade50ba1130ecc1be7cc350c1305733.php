...
unset($__errorArgs, $__bag); ?> form-control-xl" placeholder="NIP">
...
unset($__errorArgs, $__bag); ?> form-control-xl" placeholder="Nama Pegawai">
                            <div class="form-control-icon">
...
unset($__errorArgs, $__bag); ?> form-control-xl" placeholder="Jabatan">
                            <div class="form-control-icon">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" id="unit" name="unit" class="form-control <?php $__errorArgs = ['unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is invalid 
...
unset($__errorArgs, $__bag); ?> form-control-xl" placeholder="Unit Kerja">
                            <div class="form-control-icon">
...
<?php /**PATH C:\Users\Fadhlan\Documents\Joki\Rejan\DPU-Kerja Praktik\resources\views/auth/register.blade.php ENDPATH**/ ?>