                    ...
                    <div class="row">
                        ...
                        <div class="stats-icon purple mb-2" style="margin-left:4rem;">
                            ...
                            <div class="card">
                                ...
                                <a href="<?php echo e(route('pelatihan.edit', ['id' => $item->id])); ?>" class="btn btn-warning btn-sm">Edit</a>
...
<?php echo $__env->make('kerangka.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Fadhlan\Documents\Joki\Rejan\DPU-Kerja Praktik\resources\views/pelatihan/index.blade.php ENDPATH**/ ?>